...
<html>
    ...
    <body>
    <center>
        <h4>Select the file to be downloaded</h4>
        <%
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("select \"name\" from filetable2");
                ResultSet rs = ps.executeQuery();
                //out.println("<h1>FILES</h1>");
                while ( rs.next()) {
                    String name=rs.getString(1);
                    //out.println(name);
                    out.println("<a href=DownloadsServlet?name="+name+">"+name+"</a><br>");
